...
import { isEmployeeUser, saveEmployeeAuth } from "@/lib/auth";
...
export default function EmployeeRegisterPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      if (data.user && isEmployeeUser(data.user) && data.tokens) {
        saveEmployeeAuth({ user: data.user, tokens: data.tokens });
